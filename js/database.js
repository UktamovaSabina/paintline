...
const group__products__data = [
    ...
    },
    {
        ...
        sub_products: [
            ...
            {
                title: "Мономерный МДИ (чистый МДИ)",
    ...
    },
    {
        ...
        desc: "Компания Derkim Kimya, которая в последние годы увеличила свою деятельность за счет материала ТПУ, потребление которого в последние годы увеличивается благодаря его высоким механическим свойствам, поставляет ТПУ от 65 по Шору А до 97 по Шору А для текстильных покрытий, клеев, обувной промышленности и производства инъекций.",
        sub_products: [
            {
                title: "Основные области применения:",
                desc: "Подошва обуви; Разделитель; Чехол для телефона; Колесо; Серьги с животными; Труба; Кабель; Вешалка для нижнего белья; Цепь противоскольжения из ТПУ"
            }
        ]
    },
    {
        ...
        desc: "С 2010 года Derkim Kimya лидирует в этом секторе с собственными зарегистрированными брендами на турецком рынке, лидируя в секторе с герметичными компрессорами под брендом Siberia®, хладагентами марки D-Gas®, изолированными и неизолированными медными трубами и вспомогательными материалами.",
        sub_products: [
            {
